    ...
    return (
      <>
        <View
          ...
          <Button title="Test" primary></Button>
          <Card
            fullWidth
            style={{
...
interface LeaveUsageActionsProps
  extends WithTheme,
...
const LeaveUsageActionsWithTheme = withTheme<LeaveUsageActionsProps>()(
  LeaveUsageActions,
);

export default connector(LeaveUsageActionsWithTheme);
